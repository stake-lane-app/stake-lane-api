defmodule BolaoHubApiWeb.APIAuthPlugTest do
  use BolaoHubApiWeb.ConnCase
  doctest BolaoHubApiWeb.APIAuthPlug

  alias BolaoHubApiWeb.{APIAuthPlug, Endpoint}
  alias BolaoHubApi.{Repo, Users.User}

  @pow_config [otp_app: :bolao_hub_api]
